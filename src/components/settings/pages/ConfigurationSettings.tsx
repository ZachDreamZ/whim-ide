...
export function ConfigurationSettings({ settings, onChange, saving }: Props) {
  ...
  return <div className="mx-auto max-w-[760px] px-10 py-12">
    <header className="mb-9"><h1 className="text-2xl font-medium text-foreground">Configuration</h1><p className="mt-2 text-sm text-foreground/50">Agent depth, approval policy, and capability controls enforced by Whim's native agent boundary.</p></header>
