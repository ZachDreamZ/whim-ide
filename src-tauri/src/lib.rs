...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            backend::productivity::create_pull_request,
            backend::productivity::merge_pull_request,
            backend::productivity::comment_on_pull_request,
            backend::mcp::manager::mcp_reload,
            backend::service_provisioning::list_services,
            backend::service_provisioning::provision_service,
            backend::service_provisioning::stop_service,
            backend::service_provisioning::start_service,
            backend::service_provisioning::remove_service,
            backend::service_provisioning::service_status,
