...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            backend::workspace::get_inbox_messages,
            backend::workspace::send_inbox_message,
            backend::workspace::clear_inbox_messages,
            ...
            capabilities::validate_capability_configuration_cmd,
            capabilities::get_capability_dependencies_cmd,
            capabilities::get_capability_conflicts_cmd,
            ...
            backend::provider::discover_providers_with_health,
            backend::provider::get_best_provider,
            backend::provider::select_provider_with_fallback,
